...
if not ret then
    local KeyWindow = Fluent:CreateWindow{
        Title = "Fire Scripts | Project Slayers - Key System",
    ...
    TabsKey.Main:AddButton({
        ...
        Callback = function()
            setclipboard("https://ninja974.github.io/Fire-Scripts.github.io/")
            Fluent:Notify({
                Title = "Copied!",
...
if validKey and #validKey == 32 then
    ...
    Fluent:Notify({
        Title = "Loading Project Slayers Script",
        Content = "Check console by F9 if script doesn't load. If stuck at 95%, re-execute.",
        Duration = 5
    })
    loadstring(game:HttpGet("https://api.luarmor.net/files/v3/loaders/acdced2352def79bef163e2db39d2ec5.lua"))()
end
